			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					<div class="breadcrumbs">
						<a type="button" href="<?php echo site_url(module_folder(5).'/consulting_questions/index/');?>" class="btn btn-xs btn-primary" style="margin:0px 50px;">咨询常见问题</a>
						<span style="font-size:16px;margin-left:70px;font-weight:bold;">|修改常见问题|</span>
					</div>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 问题： </label>

										<div class="col-sm-9">
											<input type="text" value="<?php echo $questions_info['questions_name'];?>" name="question" id="form-input-readonly" class="col-xs-10 col-sm-4">
											&nbsp;&nbsp;
											...
											<br /><br />
											<div class="add_file">
												<?php foreach ($question_files as $key => $value) {?>
													<p class="show_img">
														<img src="<?php echo base_url($value['file_url']);?>" width="200px" height="100px"  />
														<input type="button" value="删除" class="delete_file" data-id="<?php echo $value['file_id'];?>" />
													</p>
												<?php }?>
											</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea cols="50" rows="10" id="answer" name="answer" style="float:left;"><?php echo $questions_info['questions_answer'];?></textarea>
											&nbsp;&nbsp;
											<button id="answer_file_add" type="button" class="btn spinner-up btn-xs btn-success" style="float:left; margin-left:10px;">
												<i class="icon-plus smaller-75">修改图片</i>
											</button>

											<br /><br />
											<div class="add_file">
												<?php foreach ($answer_files as $key => $value) {?>
													<p class="show_img">
														<img src="<?php echo base_url($value['file_url']);?>" width="200px" height="100px"  />
														<input type="button" value="删除" class="delete_file" data-id="<?php echo $value['file_id'];?>" />
													</p>
	 			...
	 			$('.delete_file').click(function() {
	 				...
	 				bootbox.confirm("你确定删除吗?", function(result) {
						if(result) {
							...
							$.ajax({
							    type: "POST",
							    url: "<?php echo site_url(module_folder(5).'/consulting_questions/delete_file');?>",
