					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="<?php echo site_url(module_folder(2).'/consultant_record/add');?>">
									<input type="hidden" name="client" value="<?php echo $client;?>" />
									<div class="form-group">
										<input type="hidden" name="employee_id" value="<?php echo $name['employee_id'];?>" />
										<label class="col-sm-4 control-label">
											<?php if(isset($client) && $client){echo '客户';}else{echo '咨询者';}?>姓名: <?php echo $name['consultant_name'];?>
										</label>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control date-picker" id="id-date-picker-1" type="text" value="<?php echo date('Y-m-d')?>" name="day" data-date-format="yyyy-mm-dd" />
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<textarea id="form-field-1" style="height:314px;width:501px;" class="form-control" name="description" placeholder="请输入咨询效果" required oninvalid="setCustomValidity('请输入咨询效果');" oninput="setCustomValidity('');"></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 咨询类型</label>
										
										<div class="col-sm-9">
										<?php if($viewtime_status['consultant_set_view']==1){?>
											<span>已上门</span>
										<?php }elseif ($viewtime_status['consultant_set_view']==0) { ?>
											<label>
												<input class="ace" type="radio" name="visit" value="1">
												<span class="lbl" style="z-index:9;">已上门</span>
											</label>
											<label>
												<input class="ace" checked type="radio" name="visit" value="2">
												<span class="lbl" style="z-index:9;">未上门</span>
											</label>
										<?php }?>
																				
										<?php if($name['is_student']==1){?>
											<span>已报名</span>
										<?php }?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea style="width:505px; height:77px;" id="form-field-1" name="remind_remark" placeholder="请输入提醒备注"></textarea>
										</div>
									</div>
