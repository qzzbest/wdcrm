<div class="nav-search" id="nav-search">
	<form name="student_search" class="form-search" action="" method="get">
		...
		<!-- 	<select class="form-control" name="key">
					<option <?php if(isset($student_info['key']) && $student_info['key'] == 'student_name'){ echo 'selected=selected';}?> value="student_name"></option>
		...
		<span class="input-icon">
			<input type="text" name="search" placeholder="Search ..." class="nav-search-input" id="nav-search-input" autocomplete="off" value="<?php if(isset($seach))echo $seach;?>" />
...
<script>
	//搜索学生的相关信息
		jQuery(function($){
			...
			var url='<?php echo site_url(module_folder(5).'/student/index/index/0');?>';
