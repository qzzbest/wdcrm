					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form name="edit" class="form-horizontal" role="form" method="post" action="<?php echo site_url(module_folder(1).'/marketing_specialist/edit');?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 市场专员 </label>

										<div class="col-sm-3">
											<input type="text" value="<?php echo $info['marketing_specialist_name'];?>" id="form-field-1" placeholder="请输入市场专员" class="col-xs-10 col-sm-12" name="marketing_specialist_name" required oninvalid="setCustomValidity('请输入市场专员');" oninput="setCustomValidity('');" />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="marketing_specialist_desc" style="width:278px; height:130px;" placeholder="请输入市场专员描述"><?php echo $info['marketing_specialist_desc'];?></textarea>
										</div>
									</div>

									<div class="space-4"></div>
									<input type="hidden" name="marketing_specialist_id" value="<?php echo $info['marketing_specialist_id'];?>">
		...
		//
			...
			jQuery(function($){
				...
				$('form[name="edit"]').submit(function(){
					...
					var id=$('input[name="marketing_specialist_id"]').val();
