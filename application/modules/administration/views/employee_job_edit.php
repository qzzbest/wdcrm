					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form name="edit" class="form-horizontal" role="form" method="post" action="<?php echo site_url(module_folder(1).'/employee_job/edit');?>">
									<input type="hidden" name="id" value="<?php echo $info['employee_job_id'];?>" />
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right"> 员工职位 </label>

										<div class="col-sm-3">
											<input type="text" placeholder="请输入员工职位" value="<?php echo $info['employee_job_name'];?>" class="col-xs-10 col-sm-12" name="employee_job_name" required oninvalid="setCustomValidity('请输入员工职位');" oninput="setCustomValidity('');" />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<textarea class="form-control" name="desc" style="width:278px; height:130px;" placeholder="员工职位描述信息"><?php echo $info['employee_job_desc'];?></textarea>
										</div>
									</div>
