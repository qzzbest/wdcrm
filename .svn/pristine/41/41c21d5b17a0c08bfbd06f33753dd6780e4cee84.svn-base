					...
					<div class="page-content">
						<div class="page-header">
							<h3 style="margin-top:0px;margin-bottom:0px;">
								客户姓名:<?php echo $info['consultant_name'];?>
								<a class="btn btn-xs btn-info" role="button" href="<?php echo site_url(module_folder(2).'/client_project/add/'.$info['consultant_id']);?>">添加新项目</a>
								<a href="<?php echo site_url(module_folder(2).'/project_payment/index/'.$info['consultant_id']);?>" class="btn btn-xs btn-success" role="button">缴费记录</a>
							</h3>
						</div>
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive">
											<form name="delete" action="<?php echo site_url(module_folder(2).'/client_project/delete');?>" method="post">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<?php foreach ($list as $key=>$value) {?>	
													<tr>
														...
														<td class="center"><?php echo $value['project_name'];?></td>
														<td class="center"><a href="<?php echo $value['project_url'];?>" target="_blank"><?php echo $value['project_url'];?></a></td>
														<td class="center"><?php echo $value['project_remark'];?></td>
														<td class="center">
															<a class="btn btn-xs btn-info" role="button" href="<?php echo site_url(module_folder(2).'/client_project/edit/'.$value['consultant_id'].'/'.$value['repayment_id']);?>">修改项目</a>
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('.course_info').click(function(){
					...
					$.ajax({
				        type: "POST",
				        url: "<?php echo site_url(module_folder(2).'/client_project/info');?>",
