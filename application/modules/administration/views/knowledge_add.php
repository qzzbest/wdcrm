					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="add" role="form" method="post" action="<?php echo site_url(module_folder(1).'/knowledge/add');?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 知识点 </label>

										<div class="col-sm-3">
											<input type="text" id="form-field-2" class="col-xs-10 col-sm-12" placeholder="请输入知识点名称" required oninvalid="setCustomValidity('请输入知识点名称');" oninput="setCustomValidity('');" name="knowledge_name" />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" id="form-field-2" class="col-xs-10 col-sm-12" placeholder="请输入课时" name="knowledge_lesson"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" id="form-field-2" class="col-xs-10 col-sm-12" placeholder="请输入排序" name="knowledge_order" required oninvalid="setCustomValidity('请输入排序');" oninput="setCustomValidity('');" />
										</div>
