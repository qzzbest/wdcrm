			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					<div class="breadcrumbs">
						...
						<span style="font-size:16px;margin-left:70px;font-weight:bold;">|添加常见问题|</span>
					</div>
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data"><?php echo validation_errors();?>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 问题： </label>

										<div class="col-sm-9">
											<input type="text" value="" name="question" id="form-input-readonly" class="col-xs-10 col-sm-4">
											&nbsp;&nbsp;
											<button id="question_file_add" type="button" class="btn spinner-up btn-xs btn-success">
												<i class="icon-plus">添加图片</i>
											</button>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="answer" name="answer" style="float:left;"></textarea>
											&nbsp;&nbsp;
