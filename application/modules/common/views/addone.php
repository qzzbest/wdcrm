			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					<div class="breadcrumbs">
						...
						<span style="font-size:16px;margin-left:70px;font-weight:bold;">|添加评分标准|</span>
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form method="post" action="<?php echo site_url(module_folder(5).'/marking/add_one');?>">
										...
										<tr>
											<td>内容：</td>
											<td><textarea cols="60" rows="10" style="margin:5px 20px" name="content"></textarea><span class="cur_msg"></span></td>
										</tr>

										<tr>
											<td>备注：</td>
											<td><textarea cols="60" rows="6" style="margin:5px 20px" name="remark"></textarea><span class="mark_msg"></span></td>
										</tr>
