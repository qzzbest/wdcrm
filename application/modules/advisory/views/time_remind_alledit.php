...
<html lang="en">
	...
	<body>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="<?php echo site_url(module_folder(2).'/remind/allEdit');?>">
								<input type="hidden" name="ids" value="<?php echo $ids;?>">
								<input type="hidden" name="record_ids" value="<?php echo $record_ids;?>">
								<?php foreach ($list as $key => $value) {?>
								<div>
								<input type="hidden" name="id[]" value="<?php echo  $value['time_remind_id'];?>">
								<input type="hidden" name="consultant_id[]" value="<?php echo  $value['consultant_id'];?>">
								<input type="hidden" name="student_id[]" value="<?php echo  $value['student_id'];?>">
								<input type="hidden" name="consultant_record_id[]" value="<?php echo  $value['consultant_record_id'];?>">
								<input type="hidden" name="repayment_id[]" value="<?php echo  $value['repayment_id'];?>">
		...
		<div name="remind" style="display:none;">
			...
			<input type="hidden" name="consultant_record_id[]" value="">
