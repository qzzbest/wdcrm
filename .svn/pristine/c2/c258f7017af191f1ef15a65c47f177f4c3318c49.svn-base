				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" name="add" role="form" method="post" action="<?php echo site_url(module_folder(4).'/classroom/add');?>">
										...
										<div class="col-sm-3">
											<select class="form-control" name="classroom_type" required>
												...
												<?php foreach($classroom_type as $item){?>
													<option value="<?php echo $item['classroom_type_id'];?>"><?php echo $item['classroom_type_name'];?></option>
												<?php }?>
											</select>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" required id="form-field-2" class="col-xs-10 col-sm-12" placeholder="请输入班级名称" name="classroom_name"/>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" id="form-field-2" class="col-xs-10 col-sm-12" placeholder="请输入班级群号" name="classroom_group"/>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" id="form-field-2" class="col-xs-10 col-sm-12" placeholder="请输入上课地点" required name="class_address"/>
										</div>
									</div>
									<div class="space-4"></div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 上课时间 </label>
										<div class="col-sm-3">
											<input type="text" id="form-field-2" class="col-xs-10 col-sm-12" placeholder="请输入上课时间" required name="class_time"/>
										</div>
									</div>
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<div class="input-group">
												<input class="form-control date-picker" required id="id-date-picker-1" type="text" value="<?php echo date('Y-m-d')?>" name="open_classtime" data-date-format="yyyy-mm-dd" />
