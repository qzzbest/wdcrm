					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="<?php echo site_url(module_folder(2).'/student_course/add');?>" method="post" id="setStudent">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">学费说明：</label>
											...
											<div class="col-sm-6">
							      				<input type="text" name="payment_desc" placeholder="学费说明" />(注释： ....)
							      			</div>
									</div>
									<div class="space-4"></div>
											...
											<table style="display:none; margin: 0 auto;" id="payment_two">
												<tr>
											 	...
											 	<tr>
											 		...
											 		<td><input type="text" name="payment_money1[]" placeholder="应缴费金额" /></td>
											...
											<table style="display:none; margin: 0 auto;" id="payment_three">
												...
												<tr>
												 	<td><input type="text" data-target="#dateShow" data-date-format="yyyy/mm/dd" name="payment_time2[]" placeholder="补贴日期" /></td>
												 		<td><input type="text" name="payment_money2[]" placeholder="补贴金额" /></td>
