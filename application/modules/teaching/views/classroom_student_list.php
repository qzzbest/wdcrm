								...
								<span class="btn-xs">课程进度：
									...
									<?php }else{ ?>
											...
											if($value['schedule_state'] == 2){
												?>
												<a href="" class="btn btn-xs btn-primary tooltip-info" role="button" data-toggle="modal" data-target="#course_schedule" course_type="<?php echo $value['schedule_state'];?>" cls_konwid="<?php echo $value['id'];?>" course_id="<?php echo $value['knowledge_id'];?>" course_name="<?php echo $value['knowledge_name'];?>"  data-rel="tooltip" data-placement="bottom" title="<?php echo $value['knowledge_lesson'];?>"><?php echo $value['knowledge_name'];?></a>
											<?php }else if($value['schedule_state'] == 1){?> 
												<a href="" class="btn btn-xs btn-danger tooltip-info" role="button" data-toggle="modal" data-target="#course_schedule" course_type="<?php echo $value['schedule_state'];?>" cls_konwid="<?php echo $value['id'];?>" course_id="<?php echo $value['knowledge_id'];?>" course_name="<?php echo $value['knowledge_name'];?>"  data-rel="tooltip" data-placement="bottom" title="<?php echo $value['knowledge_lesson'];?>"><?php echo $value['knowledge_name'];?></a>
											<?php }else{?> 
												<a href="" class="btn btn-xs btn-warning tooltip-info" role="button" data-toggle="modal" data-target="#course_schedule" course_type="<?php echo $value['schedule_state'];?>" cls_konwid="<?php echo $value['id'];?>" course_id="<?php echo $value['knowledge_id'];?>" course_name="<?php echo $value['knowledge_name'];?>"  data-rel="tooltip" data-placement="bottom" title="<?php echo $value['knowledge_lesson'];?>"><?php echo $value['knowledge_name'];?></a>
											<?php }
											}?>
										<span style="color:red;">（蓝色：已读；橙色：未读）</span>
									<?php }?>
								</span>	
							</h3>
							<?php
