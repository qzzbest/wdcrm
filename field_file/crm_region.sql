...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='省市区联动菜单' AUTO_INCREMENT=3409 ;

--
-- 转存表中的数据 `crm_region`
--

INSERT INTO `crm_region` (`region_id`, `parent_id`, `region_name`, `region_type`, `agency_id`) VALUES
(1, 0, '中国', 0, 0),
(2, 1, '北京', 1, 0),
(3, 1, '安徽', 1, 0),
(4, 1, '福建', 1, 0),
