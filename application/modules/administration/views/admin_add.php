							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="add" role="form" method="post" action="<?php echo site_url(module_folder(1).'/admin/add');?>">
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" id="form-field-1" placeholder="请输入用户名" class="col-xs-10 col-sm-12" name="username" required oninvalid="setCustomValidity('请输入用户名');" oninput="setCustomValidity('');" />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input required type="password" id="form-field-2" placeholder="请输入密码" class="col-xs-10 col-sm-12" name="password" oninvalid="setCustomValidity('请输入密码');" oninput="setCustomValidity('');"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input required type="password" id="form-field-2" placeholder="请输入确认密码" class="col-xs-10 col-sm-12" name="pwdconfirm" oninvalid="setCustomValidity('请输入确认密码');" oninput="setCustomValidity('');" />
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-3">
											<input type="text" id="form-field-2" placeholder="请输入姓名" class="col-xs-10 col-sm-12" name="pname" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="radio" name="mark_power" value="1" />评分权
											&nbsp;&nbsp;
											<input type="radio" name="mark_power" value="2" />审核和添加标准等所有权
										</div>
									</div>
									<?php }?>
