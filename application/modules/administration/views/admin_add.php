	...
	<body>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="add" role="form" method="post" action="<?php echo site_url(module_folder(1).'/admin/add');?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" id="form-field-2" placeholder="手机号码" class="col-xs-10 col-sm-8" name="emplpyee_phone[]" />
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" id="form-field-2" placeholder="QQ" class="col-xs-10 col-sm-8" name="emplpyee_qq[]" />
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" id="form-field-2" placeholder="邮箱" class="col-xs-10 col-sm-8" name="emplpyee_email[]" />
											<label style="float:left;margin-left:15px;">
												<input type="checkbox" class="ace" onclick="hit(this)" />
		...
		<textarea name="phone" style="display:none;">
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="emplpyee_phone[]" placeholder="手机号码" class="col-xs-10 col-sm-8" type-data="true" />
					<label style="float:left;margin-left:15px;">
						<input type="checkbox" class="ace" onclick="hit(this)" />
						<span class="lbl">工作手机</span>
					</label>
	 	...
	 	<textarea name="qq" style="display:none;">
			<div class="form-group">
				<div class="col-sm-3"></div>
				<div class="col-sm-5">
					<input type="text" name="emplpyee_qq[]" placeholder="QQ" class="col-xs-10 col-sm-8" />
					<label style="float:left;margin-left:15px;">
						<input type="checkbox" class="ace" onclick="hit(this)" />
						<span class="lbl">工作QQ</span>
					</label>
	 	...
	 	<textarea name="email" style="display:none;">
			<div class="form-group">
				<div class="col-sm-3"></div>
				<div class="col-sm-5">
					<input type="text" name="emplpyee_email[]" placeholder="邮箱" class="col-xs-10 col-sm-8" />
					<label style="float:left;margin-left:15px;">
						<input type="checkbox" class="ace" onclick="hit(this)" />
						<span class="lbl">工作邮箱</span>
					</label>
	 	...
	 	<textarea name="weixin" style="display:none;">
			<div class="form-group">
				<div class="col-sm-3"></div>
				<div class="col-sm-4">
					<input type="text" name="emplpyee_weixin[]" placeholder="微信" class="col-xs-10 col-sm-10" />
					<div class="spinner-buttons input-group-btn" style="text-align:center;">
						<button type="button" onclick="wdcrm.removeInput(this,3);" class="btn spinner-down btn-xs btn-danger">
							<i class="icon-minus smaller-75"></i>
						</button>
