				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<a role="button" class="btn btn-xs btn-info" href="<?php echo site_url(module_folder(5).'/file_data/add');?>">上传资料</a>
							<?php } ?>
							<span>总共:<em style="color:red"><?php echo $count;?></em>个资料 </span>
