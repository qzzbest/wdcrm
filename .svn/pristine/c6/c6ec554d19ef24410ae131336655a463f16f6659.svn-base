					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="<?php echo site_url(module_folder(2).'/consultant_record/edit');?>">
									...
									<div class="form-group">
										...
										<?php  
											// if($name['consultant_set_view']==1){   //已上门

											// 	if(date("Y-m-d",$list['consultant_record_time'])>=date("Y-m-d",$name['consultant_set_view_time'])){
											...
											// }else if($name['consultant_set_view']==0){  //未上门
										...
										?>
												<span>已上门</span>
											<?php }else if(date("Y-m-d",$name['consultant_set_view_time'])==date("Y-m-d",$list['consultant_record_time'])){?>
