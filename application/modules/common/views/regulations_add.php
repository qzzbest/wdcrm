...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>添加<?php echo $regulation_type_name;?></title>
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					<div class="breadcrumbs">
						...
						<span style="font-size:16px;margin-left:70px;font-weight:bold;">|添加<?php echo $regulation_type_name;?>|</span>
					</div>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" value="" name="regulation_title" id="form-input-readonly" class="col-xs-10 col-sm-4">
											<!-- &nbsp;&nbsp;
											<button id="question_file_add" type="button" class="btn spinner-up btn-xs btn-success">
												<i class="icon-plus smaller-75">添加图片</i>
											</button> -->
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea cols="50" rows="10" id="regulation_content" name="regulation_content" style="float:left;"></textarea>
											<!-- &nbsp;&nbsp;
