					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" name="add" role="form" method="post" action="<?php echo site_url(module_folder(4).'/classroom_type/add');?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 班级类型 </label>

										<div class="col-sm-3">
											<input type="text" id="form-field-2" class="col-xs-10 col-sm-12" name="classroom_type_name" placeholder="请输入班级类型" required oninvalid="setCustomValidity('请输入班级类型');" oninput="setCustomValidity('');">
										</div>
