					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="<?php echo site_url(module_folder(2).'/remind/edit');?>">
								<input type="hidden" name="id" value="<?php echo  $list['time_remind_id'];?>">
								<?php if($record_info){?>
								...
								<!-- <input type="hidden" name="id[]" value="<?php echo  $list['time_remind_id'];?>">
								<input type="hidden" name="consultant_id[]" value="<?php echo  $list['consultant_id'];?>">
								<input type="hidden" name="student_id[]" value="<?php echo  $list['student_id'];?>">
								<input type="hidden" name="consultant_record_id[]" value="<?php echo  $list['consultant_record_id'];?>">
								<input type="hidden" name="repayment_id[]" value="<?php echo  $list['repayment_id'];?>"> -->
									<div class="form-group">
										<div style="padding: 10px 20px 15px 230px;font-size: 14px;">
											<?php echo $consultant_info;?>
										</div>

										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 提醒内容 </label>

										<div class="col-sm-9">
											<textarea style="width:390px; height:150px;" id="form-field-1" name="remind_content" placeholder="请输入提醒内容"><?php echo $list['time_remind_content']?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea style="width:400px; height:50px;" id="form-field-1" name="remind_remark" placeholder="请输入提醒备注"><?php echo $list['remind_remark']?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<div class="input-group">
												<input class="form-control date-picker" id="id-date-picker-1" type="text" value="<?php echo date('Y-m-d',$list['time_remind_time']);?>" name="remind_date" data-date-format="yyyy-mm-dd" />
										...
										<div class="col-sm-4">
											<div class="input-group bootstrap-timepicker">
												<input id="timepicker1" type="text" name="remind_time" class="form-control" value="<?php echo date('H:i:s',$list['time_remind_time']);?>" />
												<span class="input-group-addon">
